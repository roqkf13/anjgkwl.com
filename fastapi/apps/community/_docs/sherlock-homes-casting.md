...
본 문서는 `community` 애플리케이션의 `adapter/inbound/api/schemas` 패키지 내에 위치할 12명의 주요 캐릭터 기반 DTO 명세서입니다. 시스템 내의 상호작용과 대립 구조를 직관적으로 파악할 수 있도록 **[경찰 및 공공기관]**, **[범인 및 전략적 대립자]**, [사설탐정 및 베이커가 조력자]의 3대 구도로 재분류했습니다.
