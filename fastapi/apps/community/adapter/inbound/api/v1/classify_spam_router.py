...
from community.adapter.inbound.api.schemas.classify_spam_schema import (
    ClassifySpamRequest,
    ClassifySpamResponseSchema,
)
from community.app.dtos.classify_spam_dto import ClassifySpamQuery
from community.app.ports.input.classify_spam_use_case import ClassifySpamUseCase
from community.dependencies.classify_spam_provider import get_classify_spam_use_case
